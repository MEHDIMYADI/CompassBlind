...
public class CompassBlindOne extends AppCompatActivity implements SensorEventListener, OnClickListener, OnInitListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compass_blind_one);
